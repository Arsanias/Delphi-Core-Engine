...
constructor TCoreLoader.Create;
begin
  FFileBitReader := nil;
...
destructor TCoreLoader.Destroy;
begin
  SafeFree(Notepad);
...
function TCoreLoader.Read(var ABuffer; ASize: Integer): Integer;
begin
...
function TCoreLoader.ReadF64: Double;
var
...
function TCoreLoader.ReadVec32(var AArray: TIntegerDynArray): Integer;
begin
  Result := Read32;
...
function TCoreLoader.ReadVec32(ABuffer: PInteger; ACount: Integer): Integer;
var
  i: Integer;
begin
...
function TCoreLoader.ReadVec32(var AArray: TInt64DynArray): Integer;
var
  i: Integer;
  ACount: Integer;
begin
...
function TCoreLoader.ReadVecU32(var AArray: TCardinalDynArray): Integer;
var
  i: Integer;
begin
  Result := Read32;
...
function TCoreLoader.ReadVecU32(var AArray: TIntegerDynArray): Integer;
var
  i: Integer;
begin
  Result := Read32;
...
function TCoreLoader.ReadVecF32(var AArray: TSingleDynArray): Integer;
begin
  Result := Read32;
  SetLength(AArray, Result);
...
function TCoreLoader.ReadVecF32(ABuffer: PSingle; ACount: Integer): Integer;
var
  i: Integer;
begin
  for i := 0 to ACount - 1 do
...
function TCoreLoader.FetchBytes(ASize: Integer): Integer;
var
  i: Integer;
...
function TCoreLoader.FetchCompressedBytes(ACompressedSize: Integer; var AUncompressedSize: Cardinal): Integer;
var
  i: Integer;
  CompressedBytes: TByteDynArray;
  ByteBufferEndPos: Cardinal;
...
function TCoreLoader.FetchCompressedBytesLZMA(ACompressedSize: Integer; var AUncompressedSize: Cardinal): Integer;
const
  ABufferSize = 65536;
var
...
function TCoreLoader.ReadGUID: TGUID;
begin
  Result.D1 := Read32;
  Result.D2 := Read16;
  Result.D3 := Read16;
...
function TCoreLoader.ReadString: string;
var
  ACount, i: Integer;
...
function TCoreLoader.ReadSignedBits(ASize: Integer): Integer;
begin
  if (ByteBuffer.Position < ByteBuffer.Capacity) then
...
function TCoreLoader.ReadUnsignedBits(ASize: Integer): Cardinal;
begin
  if (ByteBuffer.Position < ByteBuffer.Capacity) then
...
function TCoreLoader.Skip(ALength: Cardinal): Cardinal;
begin
  if (ByteBuffer.Position < ByteBuffer.Capacity) then
...
procedure TCoreLoader.SetEndian(AEndian: TByteOrder);
begin
  FEndian := AEndian;
end;

class function TCoreLoader.Dequantize(vertexCoordinates: TList<Integer>; Range: TRangeF; numberOfBits: Integer): TSingleList;
var
  minimum: Single;
  maximum: Single;
  maxCode: Int64;
...
function TCoreLoader.Seek(APosition: Int64): Int64;
begin
  Result := FFile.Seek(APosition, soFromBeginning);
end;

function TCoreLoader.ReadBytes(var ABuffer: TByteDynArray; ASize: Integer): Integer;
begin
  SetLength(ABuffer, ASize);
  Result := Read(ABuffer[0], ASize);
end;

class function TCoreLoader.BSwap32(I: DWORD): DWORD;
var
...
class function TCoreLoader.BSwap16(I: WORD): WORD;
var
...
class function TCoreLoader.BSwap64(I: UInt64): UInt64;
asm
  MOV     EDX,[EAX]
  MOV     EAX,[EAX+4]
  BSWAP   EAX
...
function TCoreLoader.IntToBin(p_nb_int: uint64; p_nb_digits: byte=64): string;
begin
...
function TCoreLoader.Open(AFileName: string): Boolean;
begin
  FFile := TFileStream.Create(AFileName, fmOpenRead);
  FFileBitReader := TBitReader.Create(FFile, boBigEndian);
end;

procedure TCoreLoader.AddLog(AClassName: string; AValueCount: Integer);
var
  AText: string;
begin
...
////////////////////////////////////////////////////////////////////////////////
// Hash Implementation from Siemens JT Specification
////////////////////////////////////////////////////////////////////////////////
