...
type
  ...
  public
    ...
    constructor Create(ADevice: ID3D11Device; ASemantics: TGX_Semantics; ATags: TShaderFlags; DxVersion: Single);
  ...
  public
    ...
    procedure AddInputElement( ASemantic: TGX_Semantic ; ASemanticName: LPCSTR; Format: TDXGI_Format; var AByteOffset: UINT );
    procedure ResetText();
    procedure AddText( AText: string ; AIncrement, ACondition: Boolean );
  public
    property ShaderInputs: TGX_Semantics read FSemantics;
    property DXVersion: Single read FDXVersion;
  end;

implementation

constructor TShaderDX.Create(ADevice: ID3D11Device; ASemantics: TGX_Semantics; ATags: TShaderFlags; DXVersion: Single);
begin
  inherited Create();
...
procedure TShaderDX.AddInputElement( ASemantic: TGX_Semantic ; ASemanticName: LPCSTR; Format: TDXGI_Format; var AByteOffset: UINT );
var
  n: Integer;
begin
