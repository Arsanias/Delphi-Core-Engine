...
type
  ...
  private
    ...
    FUseCB: Boolean;
    FVersion: Single;
    FUniformLocations: TCoreUniformLocations;
    FMipMapped: Boolean;
    FTags: TShaderFlags;
  ...
  public
    constructor Create(ASemantics: TGX_Semantics; ATags: TShaderFlags; Version: Single);
    ...
    property UniformLocations: TCoreUniformLocations read FUniformlocations;
...
constructor TCoreShaderGL.Create(ASemantics: TGX_Semantics; ATags: TShaderFlags; Version: Single);
var
...
destructor TCoreShaderGL.Destroy();
begin
...
procedure TCoreShaderGL.ResetText();
begin
  FStringList.Clear();
end;

procedure TCoreShaderGL.AddText( AText: string ; AIncrement, ACondition: Boolean );
begin
...
procedure TCoreShaderGL.CompileShader();
var
...
procedure TCoreShaderGL.CheckShaderError(AShader: GLhandle);
var
  blen, slen: GLInt;
  InfoLog: PGLChar;
  AMessage: Ansistring;
...
procedure TCoreShaderGL.CheckProgramError();
var
  blen, slen: GLInt;
  InfoLog: PGLCharARB;
  AMessage: Ansistring;
...
function TCoreShaderGL.ReadVersion(): string;
begin
  //AddText( '#version ' + IntToStr(FVersion),                                                    False, True );
  //AddText( '',                                                                                    False, True );
end;

function TCoreShaderGL.ReadConstants(): string;
begin
...
function TCoreShaderGL.ReadVariables(): string;
begin
  AddText( '',                                                                                    False, True );
end;

function TCoreShaderGL.ReadInputLayout(): string;
begin
  FIndex := 0;
...
function TCoreShaderGL.ReadVertexFunc(): string;
begin
  ReadInputLayout();
...
function TCoreShaderGL.ReadPixelFunc(): string;
begin
...
function TCoreShaderGL.ReadVertexCode(): string;
begin
  ResetText();
...
function TCoreShaderGL.ReadPixelCode(): string;
begin
  ResetText();
